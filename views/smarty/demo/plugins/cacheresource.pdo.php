...
class Smarty_CacheResource_Pdo extends Smarty_CacheResource_Custom
{
     ...
     * @param string $core : optionnal - if table is located in another db
     */
     ...
     * 
     * @param string        $columns : the column(s) name(s) you want to retrieve from the core
    ...
    /* 
     * Encodes the content before saving to core
     * 
    ...
    /* 
     * Decodes the content before saving to core
     * 
     * @param string $content 
     * @return string $content 
     * @access protected 
